...
IF NOT EXIST "%APP_PATH%/setup" (
    call curl -fLo %APP_PATH%/setup/gvim81.exe --create-dirs "https://ftp.nluug.nl/pub/vim/pc/gvim81.exe"
    chdir /d "%APP_PATH%"/setup
    call gvim81.exe
    rd /s /Q "%APP_PATH%"/setup
)

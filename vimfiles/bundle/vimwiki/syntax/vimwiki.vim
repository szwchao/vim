...
"隐藏{{{和}}}
if exists("+conceallevel")
  execute 'syntax region VimwikiPre matchgroup=VimwikiIgnore start=/'.g:vimwiki_rxPreStart.
      \ '/ end=/'.g:vimwiki_rxPreEnd.'/ contains=VimwikiComment concealends'
else
  execute 'syntax region VimwikiPre matchgroup=VimwikiIgnore start=/'.g:vimwiki_rxPreStart.
      \ '/ end=/'.g:vimwiki_rxPreEnd.'/ contains=VimwikiComment'
endif
execute "syntax sync ccomment VimwikiPre minlines=50"
...
if g:vimwiki_hl_headers == 0
  ...
  if &background == 'light'
    hi def VimwikiHeader1 guibg=bg guifg=#aa5858 gui=bold ctermfg=DarkRed   term=bold cterm=bold
    hi def VimwikiHeader2 guibg=bg guifg=#2E8B57 gui=bold ctermfg=DarkGreen term=bold cterm=bold
    hi def VimwikiHeader3 guibg=bg guifg=#1030a0 gui=bold ctermfg=DarkBlue  term=bold cterm=bold
    hi def VimwikiHeader4 guibg=bg guifg=#B8860B gui=bold ctermfg=Black     term=bold cterm=bold
    hi def VimwikiHeader5 guibg=bg guifg=#507030 gui=bold ctermfg=Black     term=bold cterm=bold
    hi def VimwikiHeader6 guibg=bg guifg=#8A2BE2 gui=bold ctermfg=Black     term=bold cterm=bold
  else
    hi def VimwikiHeader1 guibg=bg guifg=#e08090 gui=bold ctermfg=Red       term=bold cterm=bold
    hi def VimwikiHeader2 guibg=bg guifg=#80e090 gui=bold ctermfg=Green     term=bold cterm=bold
    hi def VimwikiHeader3 guibg=bg guifg=#6090e0 gui=bold ctermfg=Blue      term=bold cterm=bold
    hi def VimwikiHeader4 guibg=bg guifg=#DAA520 gui=bold ctermfg=White     term=bold cterm=bold
    hi def VimwikiHeader5 guibg=bg guifg=#556B2F gui=bold ctermfg=White     term=bold cterm=bold
    hi def VimwikiHeader6 guibg=bg guifg=#6A5ACD gui=bold ctermfg=White     term=bold cterm=bold
  endif
endif

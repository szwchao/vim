...
function s:initialize()
  ...
  call l9#defineVariableDefault('g:fuf_keyOpenSplit'     , '<C-o>')
  call l9#defineVariableDefault('g:fuf_keyOpenVsplit'    , '<C-i>')
  ...
  "---------------------------------------------------------------------------
  call l9#defineVariableDefault('g:fuf_mycmd_prompt'     , '>MyCmd[]>')
  call l9#defineVariableDefault('g:fuf_mycmd_switchOrder', 160)
  "---------------------------------------------------------------------------
  call l9#defineVariableDefault('g:fuf_mytaggedfile_prompt'     , '>NoProject>')
  call l9#defineVariableDefault('g:fuf_mytaggedfile_switchOrder', 160)
  "---------------------------------------------------------------------------
  ...
  call fuf#addMode('mycmd')
  call fuf#addMode('mytaggedfile')
  "---------------------------------------------------------------------------
endfunction

...
"  call Dfunc("Vm_place_sign()")
  ...
  let vFlagNum = (b:Vm_sign_number < 10 ? "0" . b:Vm_sign_number : b:Vm_sign_number)
  exe 'sign define SignSymbol' . vFlagNum . ' text=' . vFlagNum . ' linehl=SignColor texthl=SignColor'
  exe 'sign place ' . vFlagNum . ' line=' . ln . ' name=SignSymbol'. vFlagNum. ' buffer=' . winbufnr(0)
